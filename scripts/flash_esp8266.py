...
FACEPLATE = "hardware/classes/esp8266-oled/faceplates/numerals/down-mount/main.py"
...
payload = [
    ...
    ("main.py", open("hardware/classes/esp8266-oled/faceplates/numerals/down-mount/main.py", "rb").read()),
]
